...
Through this paper, I contribute to the very reduced stream of research which analyses the impact of entry regulations on employment, considering the existence of informal and formal sectors. Further, the use of administrative instead of survey data enhances the possibilities of extracting insight which is valid at any level of disaggregation and also enhance data quality of the reporting of formal employment. Research on the Ecuadorian economy, which is unfortunate given the possibilities of extracting policy-relevant insight for highly informal economies, specially considering the fact that monetary policy is not feasible in a dollarized economy like Ecuador. The low level of formal sector employment is a persistent issue in Latin America and findings like these can illustrate the need of coordination between policies of market liberalisation. 
